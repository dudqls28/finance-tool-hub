    ...
    <div className="space-y-6">
      <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          <InputField id="price" label={locale === 'en' ? 'Home price' : '주택 가격'} value={homePrice} onChange={setHomePrice} unit={unit} />
          <InputField id="down" label={locale === 'en' ? 'Down payment' : '계약금·중도금'} value={downPayment} onChange={setDownPayment} unit={unit} />
